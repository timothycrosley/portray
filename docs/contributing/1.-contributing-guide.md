...
2. Clone your fork to your local file system:
    `git clone https://github.com/$GITHUB_ACCOUNT/portray.git`
3. `cd portray
4. `poetry install`
...
1. Check the [issues page](https://github.com/timothycrosley/portray/issues) on GitHub to see if the task you want to complete is listed there.
