...
> The only thing worse than documentation never written, is documentation never portrayed to users.

**portray** is a Python3 command line tool and library that helps you create great documentation for your Python projects with as little effort as possible.
